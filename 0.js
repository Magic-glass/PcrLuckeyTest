...
var lilys = [
	"爱梅斯","爱蜜莉雅","安","斑比","碧","碧（插班生）","碧（工作服）","碧（露营）","步美","步美（怪盗）","步美（仙境）","初音","初音、栞","初音（夏日）","纯","纯（夏日）","帆稀","纺希","纺希（万圣节）","纺希（夏日）","宫子","宫子（圣诞节）","宫子（万圣节）","古蕾雅","胡桃","胡桃（圣诞节）","胡桃（舞台）","环奈","环奈（振袖）","惠理子","惠理子（情人节）","惠理子（夏日）","姬塔","佳凛","嘉夜","嘉夜(时间旅行)","镜华","镜华（万圣节）","镜华（夏日）","静流","静流（情人节）","静流（夏日）","凯露","凯露（公主）","凯露（Overload）","凯露（夏日）","凯露（新年）","栞","栞（魔法少女）","可可萝","可可萝（公主）","可可萝（礼服）","可可萝（夏日）","可可萝（新年）","克蕾琪塔","克莉丝提娜","克莉丝提娜（圣诞节）","克罗依","克罗依（圣学祭）","空花","空花（暗黑）","空花（大江户）","菈比莉斯塔","菈比莉斯塔（Overload）","拉姆","兰法","雷姆","莉玛","莉玛（灰姑娘）","璃乃","璃乃（圣诞节）","璃乃（仙境）","怜","怜（公主）","怜（万圣节）","怜（夏日）","怜（新年）","凛（偶像大师）","铃","铃（万圣节）","铃（游骑兵）","铃莓","铃莓（夏日）","铃莓（新年）","铃奈","铃奈（万圣节）","铃奈（夏日）","绫音","绫音（圣诞节）","绫音（探险家）","流夏","流夏（夏日）","流夏（新年）","露","露娜","矛依未","矛依未（新年）","卯月（偶像大师）","美冬","美冬（工作服）","美冬（夏日）","美里","美里（夏日）","美美","美美（万圣节）","美美（夏日）","美咲","美咲（万圣节）","美咲（舞台）","茉莉","茉莉（万圣节）","莫妮卡","莫妮卡（魔法少女）","妮侬","妮侬（大江户）","妮侬（万圣节）","涅娅","佩可莉姆","佩可莉姆（公主）","佩可莉姆（Overload）","佩可莉姆（夏日）","佩可莉姆（新年）","祈梨","祈梨(时间旅行)","祈梨（怪盗）","七七香","七七香（万圣节）","七七香（夏日）","千爱瑠","千爱瑠（圣学祭）","千歌","千歌（圣诞节）","千歌（夏日）","茜里","茜里（天使）","秋乃","秋乃（圣诞节）","秋乃、咲恋","忍","忍（海盗）","忍（万圣节）","日和莉","日和莉（公主）","日和莉（夏日）","日和莉（新年）","深月","深月（大江户）","似似花","似似花（新年）","望","望（圣诞节）","望（夏日）","未央（偶像大师）","未奏希","未奏希、美美、镜华","未奏希（万圣节）","未奏希（夏日）","香澄","香澄（魔法少女）","香澄（夏日）","香织","香织（万圣节）","香织（夏日）","咲恋","咲恋（圣诞节）","咲恋（夏日）","杏奈","杏奈（海盗）","杏奈（夏日）","雪","雪（大江户）","雪菲","雪菲（新年）","亚里莎","依里","依里（天使）","伊莉亚","伊莉亚（圣诞节）","伊莉亚（新年）","伊绪","伊绪（暗黑）","伊绪（夏日）","由加莉","由加莉（露营）","由加莉（圣诞节）","优妮","优妮（圣学祭）","优衣","优衣（公主）","优衣（礼服）","优衣（夏日）","优衣（新年）","真步","真步（灰姑娘）","真步（探险家）","真步（夏日）","真琴","真琴（灰姑娘）","真琴（夏日）","真阳"
	];
//=========随机内容end=========
